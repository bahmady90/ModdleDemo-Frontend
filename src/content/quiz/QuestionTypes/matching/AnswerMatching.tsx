...
export default function AnswerMatching({ children, index}: AnswerMcProps){
  ...
  return (
    <div className={`flex items-center gap-x-2  lg:gap-x-4 sm:gap-x-3 w-full justify-self-center` }>
      <button className={`${buttonStyling} rounded-full w-[90%]  border-gray-700 border-[1px] self-center px-2 py-1  sm:px-3 sm:py-2 lg:px-5 lg:py-3 ${optionMatchingStyling}`}>
