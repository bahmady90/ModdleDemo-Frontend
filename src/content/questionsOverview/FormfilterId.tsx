...
export default function FormfilterId({filterById, setFilterById, handleFilterId} : FormfilterIdProps){
    ...
    return(
        <form 
            className="max-w-[7%] text-start font-semibold text-[1.2rem] flex gap-x-1 items-center justify-center"
            ...
            <input  
                ...
                className={`text-[1rem] px-1 py-[2px] rounded-lg outline-none border-[1px] w-[50%] font-normal focus:border-2 focus:border-gray-verydark`}
            ></input>
        </form>
    )
