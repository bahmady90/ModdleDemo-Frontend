...
export default function Header(){
    ...
    return (
        ...
        <header className=" bg-gray-100 grid grid-cols-[1fr_1fr_1fr] h-[3rem] sm:h-[4rem] lg:h-[5rem] dark:bg-gray-900 items-center border-b border-gray-200 w-full">   
            ...
            <h1 className=" text-gray-verydark text-[1rem]  sm:text-[1.2rem] lg:text-[1.5rem] italic justify-self-center font-semibold font-cursive font-sans">
                MyMoodle
            </h1>
            <div className="flex sm:hidden justify-end mr-4 gap-x-4">
                ...
                {openMenu && 
                    <ul className="absolute w-[20%] top-10  right-[1%] border border-gray-200 text-[0.5rem] bg-gray-50 sm:text-sm text-gray-700 rounded-2xl gap-y-5" ref={dropdownRef}>
